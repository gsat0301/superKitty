...
function preload() {
    ...
    this.load.spritesheet('kitty', 'assets/entities/kitty.png', { frameWidth: 40, frameHeight: 40 });
    this.load.spritesheet('kitty-grow', 'assets/entities/kitty.png', { frameWidth: 50, frameHeight: 50 });
    this.load.spritesheet('kitty-fire', 'assets/entities/kitty-fire.png', { frameWidth: 50, frameHeight: 50 });
    ...
    this.load.spritesheet('flower', 'assets/collectibles/vida-flor.png', { frameWidth: 8, frameHeight: 8 });
    ...
    this.load.image('sign', 'assets/scenery/kitty.png');
